...
class Match:
    def __init__(self, tournament, clubX, clubY):
        self.tournament = tournament
        self.clubX, self.clubY = clubX, clubY
        self.clubs = [self.clubX, self.clubY]
        self.matchReport = {'tournament': self.tournament, 'clubs': {club: {} for club in self.clubs}}
        report = self.matchReport
        for club, homeAway in zip(self.clubs, ('Home', 'Away')):
            report['clubs'][club]['team'] = club.manager.selectTeam(homeAway = homeAway)
